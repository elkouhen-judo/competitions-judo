...
|---|---|---|
| `prd.md` | PRD : problème, solution, user stories, décisions d'implémentation et de tests, hors périmètre | Comprendre le "pourquoi" avant une décision produit, ou avoir une vue d'ensemble du besoin |
