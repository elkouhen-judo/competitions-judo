...
- **DASH-003a**: Before detailed metric sections, the dashboard shall display an "À retenir" summary with combats analyzed, victory rate, the most visible podium level, the main data-quality issue, and one short action-oriented insight.
